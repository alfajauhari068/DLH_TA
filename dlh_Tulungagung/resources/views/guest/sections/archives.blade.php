<section class="relative py-14 md:py-20 lg:py-28 bg-surface-green bg-noise-pattern overflow-hidden">
    ...
    <div class="container px-4 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            <div class="max-w-2xl">
                <span class="inline-block px-4 py-2 bg-surface-green text-primary-green font-bold text-xs uppercase tracking-widest rounded-full mb-6 border border-primary-green/20">Arsip & Dokumen</span>
            ...
            <a href="{{ route('publications') }}" class="group inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-700 font-bold rounded-full border border-gray-200 hover:border-primary-green hover:text-primary-green hover-lift transition-all duration-300 soft-shadow focus:outline-none focus:ring-2 focus:ring-primary-green focus:ring-offset-2">
