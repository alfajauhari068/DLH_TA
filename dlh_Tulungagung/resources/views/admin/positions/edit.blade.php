...
@section('subtitle', 'Edit structural position: ' . $position->name)
...
@section('content')
    <form action="{{ route('admin.positions.update', $position) }}" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        @csrf
        @method('PUT')
        ...
        <div class="lg:col-span-8 space-y-6">
            <x-admin.form.card title="Position Information" padding="p-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $position->name) }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('name') border-red-500 @enderror" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $position->code) }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('code') border-red-500 @enderror">
        ...
        <div class="lg:col-span-4 space-y-6">
            <x-admin.form.card title="Sorting" padding="p-6">
                <div class="mb-6">
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $position->sort_order) }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('sort_order') border-red-500 @enderror">
