        ...
        <div class="lg:col-span-8 space-y-6">
            <x-admin.form.card title="Official Profile" padding="p-6">
                ...
                <div>
                    ...
                    <textarea name="biography" id="biography" rows="6" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('biography') border-red-500 @enderror">{{ old('biography', $official->biography) }}</textarea>
