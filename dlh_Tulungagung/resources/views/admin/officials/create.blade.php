...
@section('subtitle', 'Create a new official/staff member profile.')
...
@section('content')
    <form action="{{ route('admin.officials.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        @csrf
            ...
            <x-admin.form.card title="Official Profile" padding="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('email') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('phone') border-red-500 @enderror">
        ...
        <div class="lg:col-span-4 space-y-6">
            <x-admin.form.publish-card :model="null" :statusOptions="['active' => 'Active', 'inactive' => 'Inactive']" />
            
            <x-admin.form.featured-image-card :model="null" fieldName="photo" title="Profile Photo" />
            ...
            <x-admin.form.card title="Sorting" padding="p-6">
                <div>
                    ...
                    <input type="number" name="display_order" id="display_order" value="{{ old('display_order', 0) }}" class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all @error('display_order') border-red-500 @enderror">
