        ...
        <x-ui.card>
            <form action="{{ route('admin.menus.items.update', $item) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" list="url_options" name="url" id="url" value="{{ old('url', $item->url) }}" required class="form-input w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50">
